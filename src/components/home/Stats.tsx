      ...
      <div className="max-w-[1200px] mx-auto px-8 relative z-10">
        ...
        <div className="text-center mt-12">
          <Link
            ...
            data-cursor="button"
            className="inline-flex items-center gap-2 bg-primary/40 text-white/50 font-display font-semibold px-8 py-3 rounded-full no-underline transition-all duration-300 cursor-not-allowed"
          >
            See Plans
