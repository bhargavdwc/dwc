      ...
      <div className="relative z-[2] text-center px-6 pt-8 max-w-[1000px] flex flex-col items-center justify-center h-full">
        ...
        <div className="explore-btn opacity-0 translate-y-[20px] mt-5">
          <Link
            ...
            className="inline-flex items-center gap-2 text-white/50 bg-white/5 font-display font-medium text-[0.85rem] no-underline px-6 py-2.5 rounded-full border border-white/10 transition-all duration-300 cursor-not-allowed opacity-60"
          >
