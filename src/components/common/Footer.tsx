...
const company = [
  ...
  { label: "Landing Page", path: "/sunitajethani" },
];
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-white text-sm leading-relaxed mb-6 max-w-[280px]">
              AI-Driven Digital Marketing Agency in Ahmedabad. Helping brands
              grow with strategy, creativity, and research.
            </p>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <a
                href="mailto:service@digitalwebconnection.com"
                className="text-white/60 no-underline text-sm transition-colors hover:text-primary break-all"
              >
              ...
              <a
                ...
                className="text-white/60 no-underline text-sm transition-colors hover:text-primary"
              >
                B-1103, Tittanium city center, Prahladnagar, Ahmedabad, Gujarat,
                India
              </a>
            </div>
          </div>
